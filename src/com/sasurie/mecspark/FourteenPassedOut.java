...
public class FourteenPassedOut extends Activity {
WebView webView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView= (WebView) findViewById(R.id.fourteen1);
	    ...
	    }webView.loadUrl("http://goo.gl/forms/jouJq5bIJa");
