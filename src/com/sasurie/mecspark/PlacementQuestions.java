...
public class PlacementQuestions extends Activity {
WebView webView;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView= (WebView) findViewById(R.id.pcdc);
	    ...
	    }webView.loadUrl("http://www.indiabix.com/mechanical-engineering/questions-and-answers/");
